...
class InfoSchemaApplicableRoles(Base):
    ...
    id = Column(Integer, Sequence('id_parameters_in_database'), primary_key=True)
...
class InfoSchemaColumns(Base):
    ...
    id = Column(Integer, Sequence('id_info_schema_columns'), primary_key=True)
...
class InfoSchemaDatabases(Base):
    ...
    id = Column(Integer, Sequence('id_info_schema_databases'), primary_key=True)
...
class InfoSchemaEnabledRoles(Base):
    ...
    id = Column(Integer, Sequence('id_info_schema_enabled_roles'), primary_key=True)
    role_name = Column(Text, nullable=True)
    role_owner = Column(Text, nullable=True)
    database_name = Column(String(100), nullable=True)
    company_id = Column(Integer, nullable=True)
...
class InfoSchemaExternalTables(Base):
    ...
    id = Column(Integer, Sequence('id_info_schema_external_tables'), primary_key=True)
    table_catalog = Column(Text, nullable=True)
    table_schema = Column(Text, nullable=True)
    table_name = Column(Text, nullable=True)
...
class InfoSchemaFileFormats(Base):
    ...
    id = Column(Integer, Sequence('id_info_schema_file_formats'), primary_key=True)
    ...
    file_format_type = Column(Text, nullable=True)
    record_delimiter = Column(String(10), nullable=True)
    field_delimiter = Column(String(10), nullable=True)
...
class InfoSchemaFunctions(Base):
    ...
    id = Column(Integer, Sequence('id_info_schema_functions'), primary_key=True)
...
class InfoSchemaCatlogName(Base):
    ...
    id = Column(Integer, Sequence('id_info_schema_catlog_name'), primary_key=True)
...
class InfoSchemaLoadHistory(Base):
    ...
    id = Column(Integer, Sequence('id_info_schema_load_history'), primary_key=True)
...
class InfoSchemaObjectPrivileges(Base):
    ...
    id = Column(Integer, Sequence('id_info_schema_object_privileges'), primary_key=True)
...
class InfoSchemaPipes(Base):
    ...
    id = Column(Integer, Sequence('id_info_schema_pipes'), primary_key=True)
...
class InfoSchemaProcedures(Base):
    ...
    id = Column(Integer, Sequence('id_info_schema_procedures'), primary_key=True)
...
class InfoSchemaReferentialConstraints(Base):
    ...
    id = Column(Integer, Sequence('id_info_schema_referential_constraints'), primary_key=True)
...
class InfoSchemaReplicationDatabases(Base):
    ...
    id = Column(Integer, Sequence('id_info_schema_replication_databases'), primary_key=True)
...
class InfoSchemaSchemata(Base):
    ...
    id = Column(Integer, Sequence('id_info_schema_schemata'), primary_key=True)
    catalog_name = Column(Text, nullable=True)
    schema_name = Column(Text, nullable=True)
...
class InfoSchemaSequences(Base):
    ...
    id = Column(Integer, Sequence('id_info_schema_sequences'), primary_key=True)
...
class InfoSchemaStages(Base):
    ...
    id = Column(Integer, Sequence('id_info_schema_stages'), primary_key=True)
...
class InfoSchemaTables(Base):
    ...
    id = Column(Integer, Sequence('id_info_schema_tables'), primary_key=True)
    table_catalog = Column(Text, nullable=True)
    table_schema = Column(Text, nullable=True)
    table_name = Column(Text, nullable=True)
    table_owner = Column(Text, nullable=True)
...
class InfoSchemaTablesConstraints(Base):
    ...
    id = Column(Integer, Sequence('id_info_schema_tables_constraints'), primary_key=True)
    constraint_catalog = Column(Text, nullable=True)
    constraint_schema = Column(Text, nullable=True)
    constraint_name = Column(Text, nullable=True)
    table_catalog = Column(Text, nullable=True)
...
class InfoSchemaTablesPrivileges(Base):
    ...
    id = Column(Integer, Sequence('id_info_schema_tables_privileges'), primary_key=True)
    grantor = Column(Text, nullable=True)
    grantee = Column(Text, nullable=True)
    table_catalog = Column(Text, nullable=True)
    table_schema = Column(Text, nullable=True)
...
class InfoSchemaTablesStorageMetrics(Base):
    ...
    id_table_metrics = Column(Integer, Sequence('id_info_schema_tables_metrics'), primary_key=True)
    table_catalog = Column(Text, nullable=True)
    table_schema = Column(Text, nullable=True)
    table_name = Column(Text, nullable=True)
...
class InfoSchemaUsagePrivileges(Base):
    ...
    id = Column(Integer, Sequence('id_info_schema_usage_privileges'), primary_key=True)
    grantor = Column(Text, nullable=True)
    grantee = Column(Text, nullable=True)
    object_catalog = Column(Text, nullable=True)
    object_schema = Column(Text, nullable=True)
...
class InfoSchemaViews(Base):
    ...
    id = Column(Integer, Sequence('id_info_schema_views'), primary_key=True)
    table_catalog = Column(Text, nullable=True)
    table_schema = Column(Text, nullable=True)
    table_name = Column(Text, nullable=True)
    table_owner = Column(Text, nullable=True)
